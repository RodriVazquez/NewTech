        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4 xl:gap-8">
          ...
          <div>
            ...
            <ul role="list" className="mt-6 space-y-4 text-sm">
              <li>
                <Link to="/carreras" className="hover:text-primary-400 transition-colors">Carreras Intensivas</Link>
              </li>
              <li>
                <Link to="/cursos" className="hover:text-primary-400 transition-colors">Cursos Cortos</Link>
              </li>
              <li>
                <Link to="/metodologia" className="hover:text-primary-400 transition-colors">Nuestra Metodología</Link>
              </li>
              <li>
                <Link to="/egresados" className="hover:text-primary-400 transition-colors">Historias de Éxito</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul role="list" className="mt-6 space-y-4 text-sm">
              <li>
                <Link to="/faq" className="hover:text-primary-400 transition-colors">Preguntas Frecuentes</Link>
              </li>
              <li>
                <Link to="/comunidad" className="hover:text-primary-400 transition-colors">Comunidad de Alumnos</Link>
              </li>
              <li>
                <Link to="/becas" className="hover:text-primary-400 transition-colors">Programa de Becas</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-slate-400 mb-4">
            ...
            <form className="flex max-w-sm flex-col gap-2">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full rounded-lg border border-slate-800 bg-slate-900/50 py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-slate-500 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
                />
              </div>
              <button 
                type="button" 
                className="rounded-lg bg-primary-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-primary-500"
              >
                Suscribirme
              </button>
            </form>
