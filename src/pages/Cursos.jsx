...
import { Search, Code2, LineChart, Target, Palette, Clock, BarChart as ChartIcon, BookOpen } from 'lucide-react';
    ...
    <main className="flex-1 flex flex-col bg-slate-50 pb-24">
      ...
      <section className="bg-slate-950 py-16 md:py-24 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-slate-400 mb-10">Más de 10 cursos especializados para impulsar tu carrera en la industria tecnológica.</p>
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-10">
          {categories.map((cat) => (
            <button
              ...
              className={`cursor-pointer px-6 py-2.5 rounded-full font-bold text-sm transition-all shadow-sm ${activeCategory === cat
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex flex-col gap-3">
                    <Link to={`/cursos/${curso.id}`} className="w-full flex items-center justify-center gap-2 bg-slate-950 text-white font-bold py-3.5 rounded-xl hover:bg-slate-800 transition-colors shadow-md active:scale-[0.98]">
          ...
          {filteredCursos.length === 0 && (
            <div className="col-span-full py-24 text-center">
              ...
              <button
                ...
                className="cursor-pointer mt-8 bg-white border border-slate-200 text-slate-900 font-bold py-3 px-8 rounded-full hover:bg-slate-50 transition-colors shadow-sm"
              >
                Limpiar búsqueda
              </button>
            </div>
